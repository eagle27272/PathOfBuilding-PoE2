...
2. [Navigate to the "Release new version" action](https://github.com/eagle27272/PathOfBuilding-PoE2/actions/workflows/release.yml)
3. Click "Run workflow" on the right, and fill in the values
    - Run the workflow from the 'dev' branch
    - Fill in the [most recent tag](https://github.com/eagle27272/PathOfBuilding-PoE2/tags)
...
- Clone this repository to a directory of your choice:
      ...
      git clone https://github.com/eagle27272/PathOfBuildingInstaller.git
